...
#ifndef XILINX_OMX_PLUGIN_H_

#define XILINX_OMX_PLUGIN_H_

#include <media/hardware/OMXPluginBase.h>

namespace android {

struct XilinxOMXPlugin : public OMXPluginBase {
    XilinxOMXPlugin();
    virtual ~XilinxOMXPlugin();
...
private:
    ...
    XilinxOMXPlugin(const XilinxOMXPlugin &);
    XilinxOMXPlugin &operator=(const XilinxOMXPlugin &);
};

}  // namespace android

#endif  // XILINX_OMX_PLUGIN_H_
